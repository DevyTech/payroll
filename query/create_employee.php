...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_POST['submit'] == "Submit") {
        ...
        $delEmployee = mysqli_query($conn, "DELETE FROM employee_table WHERE nik='$nik'");
        $delSalary = mysqli_query($conn, "DELETE FROM salary_table WHERE nik='$nik'");
        if ($delEmployee && $delSalary) {
